...
- File típus: [badge:gray:.BEO] (ez technikailag CSV file)
- Kódolás: [badge:gray:UTF-8]
- Fejléc: van, tartalom, egymás utáni cellákban: [badge:gray:<cég neve>], [badge:gray:<cég adószáma>], [badge:gray:<exportált hónap>]  “éééé-hh” formátumban
